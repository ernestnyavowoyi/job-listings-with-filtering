...
//     const listingContainer = $('#listing-container')[0];
//     // listingContainer.innerHTML = '<p>Loading Data...</p>'
//     console.log('loading data...');

//     // contain the job listings
...
//     // displayListings(jobListings, listingContainer);

//     attachEventHandlers(listingContainer);

// }


// function attachEventHandlers(listingContainer) {

//     const filterContentContainer = $('#filter-content ul');
//     console.log(filterContentContainer);
...
//         li.innerHTML = `<p>${filters[property]}</p> <a class="removeFilterBtn" href="#"><img src="./images/icon-remove.svg" alt="&times;"></a>`;
//         filterContentContainer.append(li);
//     }

//     $('.removeFilterBtn').on('click', event => {
//         event.preventDefault();
//         const prop = event.currentTarget.previousElementSibling.innerHTML;
//         $(event.currentTarget)[0].parentElement.remove();

//         // delete/remove the property from the filters object
//         delete filters[prop];
//         console.log(filters);
//     });
...
//         const arr = setFilter(jobListings);
//         const roleFilter = arr('role');
//         const valueFilter = roleFilter(role);
//         console.log(`Filtering listings for the ${role} role.`);
//         jobListings = valueFilter;
...
//         const arr = setFilter(jobListings);
//         const levelFilter = arr('level');
//         const valueFilter = levelFilter(level);
//         console.log(`Filtering listings for the ${level} level.`);
//         jobListings = valueFilter;
...
//         const arr = setFilter(jobListings);
//         const langFilter = arr('languages');
//         const valueFilter = langFilter(lang, true);
//         console.log(`Filtering listings for the ${lang} language.`);
//         jobListings = valueFilter;
...
//         const arr = setFilter(jobListings);
//         const toolFilter = arr('tools');
//         const valueFilter = toolFilter(tool, true);
//         console.log(`Filtering listings for the ${tool} tool.`);
//         jobListings = valueFilter;
...
// const setFilter = array => key => (value, isArray = false) => (isArray) ? array.filter(x => x[key].includes(value)) : array.filter(x => x[key] === value); 


// // Displays the formatted array at a DOM location
// const displayListings = (arr, location) => {
...
//                     <a href="#" class="role">${listing.role}</a>
//                     <a href="#" class="level">${listing.level}</a>
//                 </div>
...
//     location.innerHTML = fullJobListings;
...
function setupEventHandlers() {
    ...
    // $('a.removeFilterBtn')[0].previousElementSibling
